...
import type { InvoiceStatus } from "@saas/platform/api/types";
import { useTenant } from "@saas/platform/lib/tenant";
import { useApiMutation, fieldError } from "@saas/platform/lib/mutations";
import { formatDate, INVOICE_STATUS_LABEL, parseMoneyToCents } from "@saas/platform/lib/format";
...
import { Field, Input, MoneyInput } from "@saas/platform/components/ui/Field";
...
export function Invoices() {
  ...
  const invoices = useQuery({
    ...
    queryFn: () =>
      billingApi.listInvoices({ page, status: status || undefined, sort: "created_at" }),
