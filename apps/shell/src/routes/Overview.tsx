...
import { Spinner } from "@saas/platform/components/ui/States";
import { AppLink } from "@saas/platform/components/AppLink";
    ...
    <>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        <Section
          ...
          actions={
            <AppLink to="/crm/funil" className="text-xs font-medium text-brand-700 hover:underline">
              abrir
            </AppLink>
          }
        >
...
function Tile({
  ...
  return (
    <AppLink to={to} className="card group p-4 transition-colors hover:border-brand-200">
