...
import type { ActivityKind } from "@saas/platform/api/types";
  ...
  return (
    <>
          ...
          >
            {activities.length === 0 ? (
              <EmptyState
                ...
                message="Ligacoes, e-mails e reunioes aparecem aqui."
              />
            ) : (
      ...
      >
        <Field
          label="Motivo"
          hint="Entre 3 e 240 caracteres."
          error={fieldError(lose.error, "reason")}
        >
          <Textarea
            required
            autoFocus
