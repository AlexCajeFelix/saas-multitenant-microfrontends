...
import { crmApi, type CompanyInput } from "@saas/platform/api/crm";
import type { Company } from "@saas/platform/api/types";
...
import { formatDate } from "@saas/platform/lib/format";
...
export function Companies() {
  ...
  const companies = useQuery({
    ...
    queryFn: () =>
      crmApi.listCompanies({ page, search: search || undefined, sort: "name", order: "asc" }),
