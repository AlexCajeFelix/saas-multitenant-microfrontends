...
const NAV: { section: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/tenancy/convites", label: "Convites", icon: Mail, permission: "tenancy.invitation.read" },
      { to: "/tenancy/ajustes", label: "Ajustes", icon: Settings, permission: "tenancy.tenant.read" },
    ],
  },
  {
    section: "IAM",
    items: [
      ...
      { to: "/iam/permissoes", label: "Permissoes", icon: Layers, permission: "iam.permission.read" },
  ...
  },
  {
    section: "Projetos",
    items: [
      { to: "/projetos", label: "Projetos", icon: FolderKanban, permission: "projects.project.read" },
  ...
  },
  {
    section: "Faturamento",
    items: [
      { to: "/billing/assinatura", label: "Assinatura", icon: CreditCard, permission: "billing.subscription.read" },
      ...
      { to: "/billing/faturas", label: "Faturas", icon: Receipt, permission: "billing.invoice.read" },
    ],
  },
];
        ...
        <>
          ...
          <div className="card animate-rise absolute right-3 left-3 z-20 mt-1 max-h-72 overflow-y-auto p-1">
            ...
            <NavLink
              to="/tenants"
              onClick={() => setOpen(false)}
              className="mt-1 block rounded-md border-t border-slate-100 px-2 py-1.5 text-xs font-medium text-brand-700 hover:bg-slate-50"
            >
              Gerenciar tenants
            </NavLink>
          </div>
