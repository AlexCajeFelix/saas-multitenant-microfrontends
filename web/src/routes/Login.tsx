...
import { SEED_PASSWORD, SEED_USERS, API_URL } from "../lib/config";
      ...
      <aside className="hidden flex-col justify-between bg-slate-900 p-10 text-slate-300 lg:flex">
        ...
        <div className="max-w-md">
          ...
          <p className="mt-4 text-sm leading-relaxed">
            Tenancy, IAM, CRM, projetos e faturamento sobre Postgres com Row Level Security.
            Cada requisicao carrega o tenant corrente, e e o banco que decide o que voce ve.
          </p>
